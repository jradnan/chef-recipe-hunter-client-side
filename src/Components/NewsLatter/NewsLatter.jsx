...
const NewsLatter = () => {
    return (
        <div className='text-center lg:w-[50%] mx-auto my-20'>
            ...
            <input type="text" placeholder='Email Address Here' className='border-4 p-2 lg:w-96 md:w-96' />
            <button className="bg-[#a82d49] text-[white] lg:ml-8 btn-outline text-[15px] py-[11px] px-[48px] font-[600]">Subscribe</button>
        </div>
    );
};
