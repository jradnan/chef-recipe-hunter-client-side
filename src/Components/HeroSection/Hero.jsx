    ...
    return (
        <div className='my-[80px] lg:flex mx-auto w-full'>
            ...
            <div className="right-content w-96 ml-9 lg:mt-9">
                ...
                <p className='text-[16px] font-[400] my-3'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et purus a odio finibus bibendum in sit amet leo. Mauris feugiat erat tellus.</p>
